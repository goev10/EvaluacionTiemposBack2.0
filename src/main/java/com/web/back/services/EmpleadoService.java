...
public class EmpleadoService {
    ...
    public EmpleadoService(ZWSHREvaluacioClient zwshrEvaluacioClient, EvaluationRepository evaluationRepository, XlsxWriter xlsxWriter) {
    ...
    public byte[] getLogsXlsData(GenerateXlsRequest request) {
        ...
        try (bos; Workbook workbook = new XSSFWorkbook()) {
            ...
            evaluationXlsxes.forEach(e -> xlsxWriter.appendSheet(e.getEmployeeIncidenceList(), bos, columnTitles, workbook,
